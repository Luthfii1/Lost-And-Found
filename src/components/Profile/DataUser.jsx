...
const HeaderProfile = ({ id }) => {
    ...
    // Get data from database /user/:id
    ...
    // Convert the date format of user.birth_date become like 12 April 2003
    const date = new Date(user.birth_date);
    const birth_date = date.getDate() + ' ' + date.toLocaleString('default', { month: 'long' }) + ' ' + date.getFullYear();
